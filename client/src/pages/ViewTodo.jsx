    ...
    return (
        ...
        <div className="card card-body d-flex flex-column" style={{borderRadius: "20px"}}>
            ...
            <div className="d-flex justify-content-between px-3">
                ...
                <div>
                <i className="far fa-calendar-alt mr-3" onClick={calenderSwitch}></i>
            ...
            <hr className="my-4 mx-3" />
            <div className="px-3">
            <Link to="/delete" state={location.state} className="btn btn-secondary btn-sm"><i className="fas fa-trash"></i> Delete</Link>
            </div>
        </div>
        </div>
        </div>

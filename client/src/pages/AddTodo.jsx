        ...
        <div className="col-md-9 mx-auto">
          <div className="card card-body" style={{ borderRadius: "20px" }}>
            <div className="d-flex flex-column">
              <label htmlFor="title" className="text-muted mb-0">
                Title:{" "}
              </label>
              <input
                type="text"
                ...
                value={title}
              />
              <label htmlFor="description" className="text-muted mb-0">
                Description:{" "}
              </label>
              <textarea
              ...
              <label htmlFor="due_date" className="text-muted mb-0">
                Due date:{" "}
              </label>
              <input
                type="date"
              ...
              <div className="d-flex justify-content-between">
                <div>
                  <Link to="/" className="btn btn-secondary btn-sm">
                    <i class="fas fa-undo-alt"></i> Back to Dashboard
                  </Link>
                </div>
                <button
                  type="button"
